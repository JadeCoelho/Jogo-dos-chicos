...
const verificaJogo = () => {
    ...
    if (cardsDesabilitados.length === 40) {
        ...
        alert(`Parabéns, ${jogador.innerHTML}! Você conseguiu! 🤠 Seu tempo foi de ${tempo.innerHTML} segundos`)
